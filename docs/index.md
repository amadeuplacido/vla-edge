...
- Integrators using a ROS-based framework to bridge a variety of VLA models ported for a variety of SBCs utilised by OEMs,
- VLA model developers have a ROS-based framework to port their model to SBCs for edge applications.
...
First VLA model and SBC support for pathfinding: Raspberry Pi 5 AI HAT+ and LeRobot.
